...
max_steps = 3000
batch_size = 128
data_dir = 'H:/data/cifar-10-batches-py'
...
pool1 = tf.nn.max_pool(conv1,ksize=[1,3,3,1],strides=[1,2,2,3],padding='SAME')
norml = tf.nn.lrn(pool1,4,bias=1.0,alpha=0.001/9.0,beta=0.75)

#创建第二个卷积层
weight2 = variable_with_weight_loss(shape=[5,5,64,64],stddev=5e-2,w1=0.0)
kernel2 = tf.nn.conv2d(norml,weight2,[1,1,1,1],padding='SAME')
